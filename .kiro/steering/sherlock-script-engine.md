...
# Sherlock "Dispatch Box" Script Engine — Kiro Steering

> This steering file makes Kiro behave like the original Claude Project for this
> repository. It carries the Custom Instructions (the role) and links every
> Knowledge file so they load as context automatically in each session.
...
the project knowledge files (linked at the bottom of this document):
...
## PROJECT KNOWLEDGE FILES (always-loaded context)
The following knowledge files are the channel's source of truth. Treat them
exactly as "Project Knowledge" — read and obey them on every task.

#[[file:01-CHANNEL-BIBLE.md]]
#[[file:02-STORY-MATRIX-AND-CATEGORIES.md]]
#[[file:03-FORMAT-LIBRARY.md]]
#[[file:04-ANTI-REPETITION-SYSTEM.md]]
#[[file:05-SCRIPTING-PIPELINE.md]]
#[[file:06-TITLE-AND-THUMBNAIL-SYSTEM.md]]
#[[file:07-VICTORIAN-ASSET-BANK.md]]
#[[file:08-EPISODE-LEDGER.md]]
#[[file:09-UNTOLD-CASES-MASTERLIST.md]]
#[[file:10-EDITORIAL-HELP-GUIDE.md]]
#[[file:11-AUDIO-AND-SFX-GUIDE.md]]
#[[file:12-META-ARC-AND-CHARACTER-BIBLE.md]]
#[[file:13-STYLE-SAMPLE.md]]
#[[file:14-TTS-NARRATION-RULES.md]]
